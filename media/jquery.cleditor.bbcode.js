...
(function($) {
  ...
  $.cleditor.defaultOptions.controls =
    "bold italic underline strikethrough | bullets numbering | color size style | removeformat | " +
    "undo redo | image link unlink | source";
  $.cleditor.defaultOptions.styles = [["Header 1", "<h1>"], ["Header 2", "<h2>"],
